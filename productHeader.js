...
var ProductHeader = function (_React$Component) {
    ...
    _createClass(ProductHeader, [{
        ...
        value: function render() {
            ...
            var averageReviews = Number((this.state.reviews.map(function (r) {
                return r.stars;
            }).reduce(function (a, b) {
                return a + b;
            }, 0) / this.state.reviews.length).toFixed(1)) || 0;
            var ceilReviews = Math.ceil(averageReviews);
            var remainingReviews = TOTAL_REVIEWS - ceilReviews;
            ...
            return this.state.product ? React.createElement(
                ...
                React.createElement(
                    'div',
                    { id: 'review_summary_row', className: 'flex' },
                    React.createElement(
                        'div',
                        { className: 'flex' },
                        React.createElement(
                            'h2',
                            { id: 'product_average_review_stars' },
                            averageReviews || null
                        ),
                        React.createElement(
                            'div',
                            { id: 'review_stars' },
                            Array(ceilReviews).fill().map(function (r, i) {
                                return React.createElement(Star, { key: i, checked: true });
                            }),
                            Array(remainingReviews).fill().map(function (r, i) {
                                return React.createElement(Star, { key: i, checked: false });
                            })
                        )
                    ),
                    React.createElement(
